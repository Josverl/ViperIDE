...
const BASE = 'https://cdn.jsdelivr.net/gh/Josverl/stubs_playground@lsp-client-v0.2.5/'
...
describe('Rollup HTTPS module loader', () => {
    ...
    it('rejects mutable or non-jsDelivr base URLs', () => {
        ...
        assert.throws(
            () => httpsModuleLoader({
                baseUrl: 'https://example.com/gh/Josverl/stubs_playground@lsp-client-v0.2.5/',
            }),
            /jsdelivr/,
        )
    })
